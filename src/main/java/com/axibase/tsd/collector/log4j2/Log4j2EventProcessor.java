...
public class Log4j2EventProcessor
        implements EventProcessor <LogEvent, String, String> {
    @Override
    public SyncEventCounter<LogEvent, String> createSyncCounter() {
        return new Log4j2SyncCounter();
    }
    ...
    @Override
    public String extractKey(LogEvent event) {
